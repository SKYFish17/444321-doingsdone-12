        ...
        <main class="content__main">
          ...
          <form class="form" action="register.php" method="post" autocomplete="off">
            <div class="form__row">
              ...
              <input
                class="form__input <?php echo $errors['email'] ? 'form__input--error' : '' ?>"
                type="text"
                name="email"
                id="email"
                value="<?php echo $form_fields_value['email'] ?? ''; ?>"
            ...
            <div class="form__row">
              ...
              <input
                class="form__input <?php echo $errors['password'] ? 'form__input--error' : '' ?>"
                type="password"
                name="password"
                id="password"
                value="<?php echo $form_fields_value['password'] ?? ''; ?>"
